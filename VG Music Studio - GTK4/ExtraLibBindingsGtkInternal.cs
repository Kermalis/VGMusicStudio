...
public partial class AlertDialog : GObject.Internal.Object
{
    protected AlertDialog(IntPtr handle, bool ownedRef) : base()
    {
    }
...
public partial class FileDialog : GObject.Internal.Object
{
    ...
    private static extern void LinuxSetFilters(nint dialog, Gio.Internal.ListModel filters);

    [DllImport("libgtk-4.1.dylib", EntryPoint = "gtk_file_dialog_set_filters")]
    private static extern void MacOSSetFilters(nint dialog, Gio.Internal.ListModel filters);

    [DllImport("libgtk-4-1.dll", EntryPoint = "gtk_file_dialog_set_filters")]
    private static extern void WindowsSetFilters(nint dialog, Gio.Internal.ListModel filters);
    ...
    private static extern void LinuxOpen(nint dialog, Gtk.Internal.Window parent, Gio.Internal.Cancellable cancellable, Gio.Internal.AsyncReadyCallback callback, nint user_data);

    [DllImport("libgtk-4.1.dylib", EntryPoint = "gtk_file_dialog_open")]
    private static extern void MacOSOpen(nint dialog, Gtk.Internal.Window parent, Gio.Internal.Cancellable cancellable, Gio.Internal.AsyncReadyCallback callback, nint user_data);

    [DllImport("libgtk-4-1.dll", EntryPoint = "gtk_file_dialog_open")]
    private static extern void WindowsOpen(nint dialog, Gtk.Internal.Window parent, Gio.Internal.Cancellable cancellable, Gio.Internal.AsyncReadyCallback callback, nint user_data);

    [DllImport("libgtk-4.so.1", EntryPoint = "gtk_file_dialog_open_finish")]
    private static extern nint LinuxOpenFinish(nint dialog, Gio.Internal.AsyncResult result, GLib.Internal.Error error);

    [DllImport("libgtk-4.1.dylib", EntryPoint = "gtk_file_dialog_open_finish")]
    private static extern nint MacOSOpenFinish(nint dialog, Gio.Internal.AsyncResult result, GLib.Internal.Error error);

    [DllImport("libgtk-4-1.dll", EntryPoint = "gtk_file_dialog_open_finish")]
    private static extern nint WindowsOpenFinish(nint dialog, Gio.Internal.AsyncResult result, GLib.Internal.Error error);

    [DllImport("libgtk-4.so.1", EntryPoint = "gtk_file_dialog_save")]
    private static extern void LinuxSave(nint dialog, Gtk.Internal.Window parent, Gio.Internal.Cancellable cancellable, Gio.Internal.AsyncReadyCallback callback, nint user_data);

    [DllImport("libgtk-4.1.dylib", EntryPoint = "gtk_file_dialog_save")]
    private static extern void MacOSSave(nint dialog, Gtk.Internal.Window parent, Gio.Internal.Cancellable cancellable, Gio.Internal.AsyncReadyCallback callback, nint user_data);

    [DllImport("libgtk-4-1.dll", EntryPoint = "gtk_file_dialog_save")]
    private static extern void WindowsSave(nint dialog, Gtk.Internal.Window parent, Gio.Internal.Cancellable cancellable, Gio.Internal.AsyncReadyCallback callback, nint user_data);

    [DllImport("libgtk-4.so.1", EntryPoint = "gtk_file_dialog_save_finish")]
    private static extern nint LinuxSaveFinish(nint dialog, Gio.Internal.AsyncResult result, GLib.Internal.Error error);

    [DllImport("libgtk-4.1.dylib", EntryPoint = "gtk_file_dialog_save_finish")]
    private static extern nint MacOSSaveFinish(nint dialog, Gio.Internal.AsyncResult result, GLib.Internal.Error error);

    [DllImport("libgtk-4-1.dll", EntryPoint = "gtk_file_dialog_save_finish")]
    private static extern nint WindowsSaveFinish(nint dialog, Gio.Internal.AsyncResult result, GLib.Internal.Error error);

    [DllImport("libgtk-4.so.1", EntryPoint = "gtk_file_dialog_select_folder")]
    private static extern void LinuxSelectFolder(nint dialog, Gtk.Internal.Window parent, Gio.Internal.Cancellable cancellable, Gio.Internal.AsyncReadyCallback callback, nint user_data);

    [DllImport("libgtk-4.1.dylib", EntryPoint = "gtk_file_dialog_select_folder")]
    private static extern void MacOSSelectFolder(nint dialog, Gtk.Internal.Window parent, Gio.Internal.Cancellable cancellable, Gio.Internal.AsyncReadyCallback callback, nint user_data);

    [DllImport("libgtk-4-1.dll", EntryPoint = "gtk_file_dialog_select_folder")]
    private static extern void WindowsSelectFolder(nint dialog, Gtk.Internal.Window parent, Gio.Internal.Cancellable cancellable, Gio.Internal.AsyncReadyCallback callback, nint user_data);

    [DllImport("libgtk-4.so.1", EntryPoint = "gtk_file_dialog_select_folder_finish")]
    private static extern nint LinuxSelectFolderFinish(nint dialog, Gio.Internal.AsyncResult result, GLib.Internal.Error error);

    [DllImport("libgtk-4.1.dylib", EntryPoint = "gtk_file_dialog_select_folder_finish")]
    private static extern nint MacOSSelectFolderFinish(nint dialog, Gio.Internal.AsyncResult result, GLib.Internal.Error error);

    [DllImport("libgtk-4-1.dll", EntryPoint = "gtk_file_dialog_select_folder_finish")]
    private static extern nint WindowsSelectFolderFinish(nint dialog, Gio.Internal.AsyncResult result, GLib.Internal.Error error);

    private static IntPtr ObjPtr;
    private static IntPtr UserData;
    private GAsyncReadyCallback callbackHandle { get; set; }
    private static IntPtr FilePath;

    private FileDialog(IntPtr handle, bool ownedRef) : base()
    {
    }
    ...
    public void Open(Gtk.Internal.Window parent, Gio.Internal.Cancellable cancellable, Gio.Internal.AsyncReadyCallback callback, int user_data)
    {
        if (RuntimeInformation.IsOSPlatform(OSPlatform.Linux))
        {
    ...
    public Gio.Internal.File OpenFinish(Gio.Internal.AsyncResult result, GLib.Internal.Error error)
    {
        if (RuntimeInformation.IsOSPlatform(OSPlatform.Linux))
        {
            LinuxOpenFinish(ObjPtr, result, error);
        }
        else if (RuntimeInformation.IsOSPlatform(OSPlatform.OSX))
        {
            MacOSOpenFinish(ObjPtr, result, error);
        }
        else if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
        {
            WindowsOpenFinish(ObjPtr, result, error);
        }
    ...
    public void Save(Gtk.Internal.Window parent, Gio.Internal.Cancellable cancellable, Gio.Internal.AsyncReadyCallback callback, int user_data)
    {
        if (RuntimeInformation.IsOSPlatform(OSPlatform.Linux))
        {
    ...
    public Gio.Internal.File SaveFinish(Gio.Internal.AsyncResult result, GLib.Internal.Error error)
    {
        if (RuntimeInformation.IsOSPlatform(OSPlatform.Linux))
        {
            LinuxSaveFinish(ObjPtr, result, error);
        }
        else if (RuntimeInformation.IsOSPlatform(OSPlatform.OSX))
        {
            MacOSSaveFinish(ObjPtr, result, error);
        }
        else if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
        {
            WindowsSaveFinish(ObjPtr, result, error);
        }
    ...
    public void SelectFolder(Gtk.Internal.Window parent, Gio.Internal.Cancellable cancellable, Gio.Internal.AsyncReadyCallback callback, int user_data)
    {
        // if (cancellable is null)
        // {
        //     cancellable = Gio.Internal.Cancellable.New();
        ...
        {
            MacOSSelectFolder(ObjPtr, parent, cancellable, callback, UserData);
        }
        else if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
        {
            WindowsSelectFolder(ObjPtr, parent, cancellable, callback, UserData);
        }
    }

    // GFile* gtk_file_dialog_select_folder_finish(GtkFileDialog* self, GAsyncResult* result, GError** error)
    public Gio.Internal.File SelectFolderFinish(Gio.Internal.AsyncResult result, GLib.Internal.Error error)
    {
        if (RuntimeInformation.IsOSPlatform(OSPlatform.Linux))
        {
            LinuxSelectFolderFinish(ObjPtr, result, error);
        }
        else if (RuntimeInformation.IsOSPlatform(OSPlatform.OSX))
        {
            MacOSSelectFolderFinish(ObjPtr, result, error);
        }
        else if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
        {
            WindowsSelectFolderFinish(ObjPtr, result, error);
        }
        return SelectFolderFinish(result, error);
    }

    // GFile* gtk_file_dialog_get_initial_file (GtkFileDialog* self)
    public Gio.Internal.File GetInitialFile()
    {
        if (RuntimeInformation.IsOSPlatform(OSPlatform.Linux))
        {
    ...
    public Gio.Internal.File GetInitialFolder()
    {
        if (RuntimeInformation.IsOSPlatform(OSPlatform.Linux))
        {
    ...
    public void SetFilters(Gio.Internal.ListModel filters)
    {
        if (RuntimeInformation.IsOSPlatform(OSPlatform.Linux))
        {
            LinuxSetFilters(ObjPtr, filters);
        }
        else if (RuntimeInformation.IsOSPlatform(OSPlatform.OSX))
        {
            MacOSSetFilters(ObjPtr, filters);
        }
        else if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
        {
            WindowsSetFilters(ObjPtr, filters);
        }
    }
    ...
    public string GetPath(nint path)
    {
        ...
        {
            MacOSGetPath(FilePath);
        }
        else if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
        {
            WindowsGetPath(FilePath);
        }
