...
namespace Kermalis.VGMusicStudio.WinForms.ObjectListView {
    ...
    public class FilterMenuBuilder {
        ...
        /// </summary>
        static public Bitmap ClearFilteringImage = Kermalis.VGMusicStudio.WinForms.ObjectListView.Properties.Resources.ClearFiltering;

        /// <summary>
        /// Gets or sets the image that will be placed next to all "Apply" menu items on the filtering menu
        /// </summary>
        static public Bitmap FilteringImage = Kermalis.VGMusicStudio.WinForms.ObjectListView.Properties.Resources.Filtering;
