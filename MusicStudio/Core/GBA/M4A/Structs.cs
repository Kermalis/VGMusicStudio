...
namespace Kermalis.MusicStudio.Core.GBA.M4A
{
    class SongEntry
    {
    ...
    class VoiceEntry
    {
        ...
        /// <summary>
        /// Panpot for PCM8/Noise, Sweep for Square1
        /// </summary>
        public byte Byte3 { get; set; } // 3
        /// <summary>
        /// SquarePattern for Square1/Square2, NoisePattern for Noise, Address for PCM8/PCM4/KeySplit/Drum
        /// </summary>
        public int Int4 { get; set; } // 4
        /// <summary>
        /// ADSR for PCM8/Square1/Square2/PCM4/Noise, KeysAddress for KeySplit
        /// </summary>
        public ADSR ADSR { get; set; } // 8
        [BinaryIgnore]
        public int Int8 => (ADSR.R << 24) | (ADSR.S << 16) | (ADSR.D << 8) | (ADSR.A);
    }
    struct ADSR // Used as a struct in GBChannel
    {
    ...
    class GoldenSunPSG
    {
        public byte Unknown { get; set; } // Always 0x80
    ...
    class SampleHeader
    {
        public int DoesLoop { get; set; } // Will be 0x40000000 if true
        public int SampleRate { get; set; } // Right shift 10 for value
