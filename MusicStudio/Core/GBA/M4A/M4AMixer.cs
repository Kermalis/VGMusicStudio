...
namespace Kermalis.MusicStudio.Core.GBA.M4A
{
    class M4AMixer : Mixer
    {
        ...
        public M4AMixer(byte[] rom)
        {
            ...
            //SamplesPerBuffer = (int)(48000 / GBAUtils.AGB_FPS); // TODO
            SamplesPerBuffer = 304; // TODO
            //SampleRateReciprocal = 1f / 48000; SamplesReciprocal = 1f / SamplesPerBuffer;
            SampleRateReciprocal = 1f / 18157; SamplesReciprocal = 1f / SamplesPerBuffer;
            ...
            buffer = new BufferedWaveProvider(WaveFormat.CreateIeeeFloatWaveFormat(18157, 2)) // TODO
            {
