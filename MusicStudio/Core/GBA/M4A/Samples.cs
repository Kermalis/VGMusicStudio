...
namespace Kermalis.MusicStudio.Core.GBA.M4A
{
    ...
    {
        // Squares
        public static readonly float[] SquareD12 = new float[] { 0.50f, 0.50f, 0.50f, 0.50f, -0.50f, -0.50f, -0.50f, -0.50f };
        public static readonly float[] SquareD25 = new float[] { 0.875f, -0.125f, -0.125f, -0.125f, -0.125f, -0.125f, -0.125f, -0.125f };
        public static readonly float[] SquareD50 = new float[] { 0.75f, 0.75f, -0.25f, -0.25f, -0.25f, -0.25f, -0.25f, -0.25f };
        public static readonly float[] SquareD75 = new float[] { 0.25f, 0.25f, 0.25f, 0.25f, 0.25f, 0.25f, -0.75f, -0.75f };
